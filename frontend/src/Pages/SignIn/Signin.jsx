  ...
  const HandleSubmit = async (e) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setCookie("userType", res.data.data.user.isAdmin ? "1" : "0", {
          path: "/",
        });
  ...
  useEffect(() => {
    if (cookies.token && cookies.token !== "undefined") {
      if (cookies.userType === "0") {
        setTimeout(history("/SubmitSurvey"), 5000);
      } else {
        setTimeout(history("/RequestData"), 5000);
      }
    }
          ...
          >
            ...
            <Grid item xs={12} align='center'>
              ...
              <IconButton
                ...
                sx={{ fontSize: "40px", color: "#0A66C2" }}
              >
                <AiFillLinkedin />{" "}
              </IconButton>
              <IconButton
                href='mailto:info@componay.org'
                sx={{ fontSize: "40px", color: "#BB001B" }}
              >
                <IoMailSharp />{" "}
              </IconButton>
            </Grid>
