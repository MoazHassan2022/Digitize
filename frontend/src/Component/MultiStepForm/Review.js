...
const Review = ({data}) => {
    ...
    today = mm+'-'+dd+'-'+yyyy;
    const titles = [ "اسم المرسل" ,"تاريخ الارسال","كود المشروع" , "اسم الموقع", "اختيارات الخريطة " , "الرقم المسلسل للكابينة" , "اسم مجموعة النشاط", "نوع النشاط",
                    "وحدة القياس" , "التقدم اليومي" , "طريقة التسليم" , "ممثل فريق التوصيل" , "مهندس الموقع" , "مشرف الموقع الرئيسي" , "مشرف الموقع المساعد"];
    let datatoshow =[ cookies["name"] , today , data.project.projectCode , data["project"].siteName , data.map.img !== undefined ?  "تم ارفاق صورة" : "تم تسجيل اختيارك" ,
