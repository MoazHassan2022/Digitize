...
export default function SettingTabs() {
  ...
  var tabschose = [
    "اضف / احذف ممثل فريق توصيل",
    "اضف / احذف طريقة توصيل",
    "اضف / احذف مشرف ثانوي",
    "اضف / احذف مشرف اساسي",
    "اضف / احذف مهندس موقع",
    "اضف / احذف نوع نشاط",
    "اضف / احذف مجموعة انشطة",
    " اضف / احذف موقع ",
    "اضف / احذف مشروع",
    "اضف / احذف رقم مسلسل كابينة",
    "غير صورة لمشروع",
    "اضف / احذف وحده قياس ",
  ];
        ...
        <Grid item container xs={2}>
          {label !== "عدل صور خرائط" && (
            <IconButton onClick={() => setIsAdd(!isAdd)}>
              {isAdd ? (
                <FcAddRow title="Add item" />
              ) : (
                <FcDeleteRow title="remove item" />
              )}
            </IconButton>
          )}
        </Grid>
  ...
  const renderChose = () => {
    switch (value) {
      ...
      case 0:
        return (
          <AddRemove
            ...
            key={value}
            textonly={true}
            obsenget={objectgetlabel[value]}
            getlabel={labels[value + 1]}
            obcal={objectlabel[value]}
            getApi={getapi[value]}
            setApi={setapi[value]}
      ...
      case 10:
        return <AddRemove isAdd={isAdd} key={value} label={"عدل صور خرائط"} />;
